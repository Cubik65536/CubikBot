...
import top.cubik65536.yuq.logic.QQZoneLogic;
...
public class QQLoginController {
    ...
    public String allSign(QQLoginEntity qqLoginEntity, Group group, long qq) throws IOException {
        ...
        try {
            ...
            String str9 = qqLoginLogic.sVipMornSign(qqLoginEntity);
            String str10 = qqLoginLogic.weiYunSign(qqLoginEntity);
            String str11 = qqLoginLogic.growthLike(qqLoginEntity);
            sb.append("会员签到：").append(str1).append("\n")
                    ...
                    .append("蓝钻签到：").append(str8).append("\n")
                    .append("svip打卡报名：").append(str9).append("\n")
                    .append("微云签到：").append(str10).append("\n")
                    .append("排行榜点赞：").append(str11);
            return sb.toString();
//                return "超级签到成功！！";
        } catch (Exception e) {
