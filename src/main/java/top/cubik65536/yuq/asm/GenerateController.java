...
import top.cubik65536.yuq.pojo.ActionPojo;
import top.cubik65536.yuq.utils.IOUtils;
...
public class GenerateController {
	 ...
	 * class ASMController{
	 *
	 * @Action("sss") public String test() throw IOException{
	...
	public static byte[] generate() {
		...
		cw.visit(V1_5, ACC_PUBLIC, "top/cubik65536/yuq/controller/ASMController", null, "java/lang/Object", null);
		...
		if (list.size() != 0) {
			for (ActionPojo pojo : list) {
				...
				MethodVisitor mv = cw.visitMethod(ACC_PUBLIC, pojo.getName(), "(" + sb + ")Ljava/lang/String;", null, new String[]{"java/lang/Exception"});
				mv.visitCode();
				...
				mv.visitMethodInsn(INVOKESTATIC, "top/cubik65536/yuq/utils/OkHttpUtils", "addSingleHeader",
						"(Ljava/lang/String;Ljava/lang/String;)Lokhttp3/Headers;", false);
				mv.visitMethodInsn(INVOKESTATIC, "top/cubik65536/yuq/utils/OkHttpUtils", "getStr", "(Ljava/lang/String;Lokhttp3/Headers;)Ljava/lang/String;", false);
